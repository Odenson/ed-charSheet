...
| 2026-08-19 | **Next:** phase **8.6b** — the sustained self-cast active-effect set (fold into derived values + Initiative countdown), and **8.7** polish + Tier-1 re-check. | Pending |
