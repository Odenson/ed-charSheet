  ...
  render() {
    return html`
      <style>
        ...
        .edk-head { display: flex; justify-content: space-between; align-items: center; gap: 12px; font-size: 1rem; font-weight: 500; margin-bottom: 0.75rem; }
        .edk-close { background: none; border: none; color: var(--muted); font-size: 1.1rem; cursor: pointer; line-height: 1; padding: 0; }
        .edk-form { display: flex; flex-direction: column; gap: 0.6rem; margin: 0; }
        .edk-label { font-size: 0.62rem; text-transform: uppercase; letter-spacing: 0.05em; color: var(--muted); }
        .edk-input { font: inherit; font-size: 0.85rem; color: var(--text); background: light-dark(#f7f8fa, #1b1f27); border: 1px solid var(--border); border-radius: 6px; padding: 7px 9px; width: 100%; box-sizing: border-box; }
        ...
        .edk-hint { font-size: 0.68rem; color: var(--muted); margin: 0; line-height: 1.4; }
        .edk-actions { display: flex; justify-content: flex-end; gap: 8px; margin-top: 0.25rem; }
        .edk-btn { font: inherit; font-size: 0.82rem; padding: 6px 14px; border-radius: 6px; cursor: pointer; border: 1px solid var(--border); background: var(--bg-chip); color: var(--text); }
